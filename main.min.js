...
`<a class="btn btn-outline-primary mr-2" href="https:
`<a class="btn btn-outline-primary mr-2" href="https:
`<a class="btn btn-outline-primary mr-2" href="https:
`<br>` +
`<a class="btn btn-outline-primary mr-2" href="https:
...
const photoUrl = dash.about.photo || "https:
...
const imgTag = m.img ? `<img src="${m.img}" onerror="this.src='https:
...
const advisorImg = members.find(m => m.name === 'Kuang-Hsun Lin' || (m.role && m.role.toLowerCase() === 'advisor'))?.img || "https:
